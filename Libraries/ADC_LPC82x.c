...
uint32_t ADC_GetDataReg(LPC_ADC_Type *pADC, uint8_t index) {
	switch (index) {
		case 0: pADC->DAT0; break;
		case 1: pADC->DAT1; break;
		case 2: pADC->DAT2; break;
		case 3: pADC->DAT3; break;
		case 4: pADC->DAT4; break;
		case 5: pADC->DAT5; break;
		case 6: pADC->DAT6; break;
		case 7: pADC->DAT7; break;
		case 8: pADC->DAT8; break;
		case 9: pADC->DAT9; break;
		case 10: pADC->DAT10; break;
		case 11: pADC->DAT11; break;
	}
